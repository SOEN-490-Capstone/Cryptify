...
import { Button, Center, Link, Text, VStack } from "native-base";
    ...
    return (
        <View style={styles.view}>
            <Center alignItems="center">
                ...
                <Text textAlign={"center"}>We have sent password recovery instructions to your email.</Text>
            </Center>
            <Center style={{ flex: 1 }}></Center>
            <VStack space={"20px"} marginBottom="20px">
                <Button onPress={() => openInbox()}>Open email app</Button>
                <Text style={{ flexDirection: "row", bottom: 0 }} size={"callout"} textAlign={"center"}>
                    ...
                    <Link
                        _text={{ color: "darkBlue.500", fontWeight: "semibold", fontSize: "callout" }}
                        isUnderlined={false}
                        marginBottom={"-2.5px"}
