...
export default function NotificationsScreen({ navigation }: SettingsStackScreenProps<"NotificationsScreen">) {
        ...
        <View style={styles.view}>
            <HStack alignItems={"center"} space={19}>
                ...
                <VStack style={{maxWidth: 280, paddingRight: 75}}>
                    ...
                    <Text color="text.500" size={"footnote1"}>Send and receive transactions for all wallets</Text>
                </VStack>
                <Switch
