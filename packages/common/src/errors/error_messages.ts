...
export const ERROR_WALLET_ADDRESS_INVALID_FOR_CURRENCY = (currency: string) =>
    `Enter a valid ${currency} wallet address.`;
export const ERROR_WALLET_ALREADY_ADDED_TO_ACCOUNT  = (currency: string) => `This wallet address is already associated with another ${currency} wallet.`;
