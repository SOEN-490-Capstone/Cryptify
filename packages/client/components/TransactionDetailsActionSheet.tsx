...
import {Actionsheet, useDisclose, Radio, Text, HStack, Pressable, Link, Box} from "native-base";
                        ...
                        <Actionsheet.Item>
                            <Link 
                                ...
                                onPress={() => navigation.navigate("ContactsListScreen", {
                                    prefilledWalletAddress: isIncomingTransaction ? transaction.walletOut : transaction.walletIn,
                                })}
                            >
